...
class Field(BaseModel):
    ...
    def to_field_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "balls": self.balls,
            "center_lower": goal_by_key["center_lower"],
            "center_upper": goal_by_key["center_upper"],
            "long_1": goal_by_key["long_1"],
            "long_2": goal_by_key["long_2"],
            "loader_1": loader_by_key["loader_1"],
            "loader_2": loader_by_key["loader_2"],
            "loader_3": loader_by_key["loader_3"],
            "loader_4": loader_by_key["loader_4"],
